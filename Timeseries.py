...
#exp_mat is dataframe of pandas, split is use to split time-series different samples,
#timelag is lag of the time,numrand is the num of add random lists
...
def mainRun(expressionFile,samples,outputfile,p_lambda=0,p_alpha=1,timelag=1):
    ...
    for index in range(0, len(data.columns)):
        ...
        # max_depth=3, n_estimators=1000, learning_rate=0.0001, subsample=0.8
        clfx = xgb.XGBRegressor(max_depth=3,n_estimators=1000,learning_rate=0.0001,subsample=0.8,reg_lambda=p_lambda,
        ...
        # print(x_c)
        clf = xgb.XGBRegressor(max_depth=3, n_estimators=1000, learning_rate=0.0001, subsample=0.8, reg_lambda=p_lambda,
                               reg_alpha=p_alpha, colsample_bylevel=0.6, colsample_bytree=0.6, seed=seed)
...
mainRun("Ecoli-80_timeseries[0].tsv", 10, '200-TS.xlsx', timelag=1)
#mainRun("DREAM10/insilico_size10_2_timeseries.tsv", 10, '2.xls')
#time.sleep(5)
#mainRun("DREAM10/insilico_size10_3_timeseries.tsv", 10, '3.xls')
#time.sleep(5)
#mainRun("DREAM10/insilico_size10_4_timeseries.tsv", 10, '4.xls')
#time.sleep(5)
#mainRun("DREAM10/insilico_size10_5_timeseries.tsv", 10, '5.xls')
